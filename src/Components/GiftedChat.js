...
class GiftedChat extends React.Component {
    ...
    componentDidMount() {
        ...
        // console.log('GiftedChat - ComponentDidMount - messages', messages);
        this.setIsMounted(true);
        this.initLocale();
        this.setMessages(messages || []);
        this.setTextFromProp(text);
        this.onInitialLayoutViewLayout();
    }
    ...
    componentDidUpdate(prevProps = {}) {
        const { messages, text } = this.props;
        // console.log('GiftedChat - componentDidUpdate - messages', messages);
        if (messages !== prevProps.messages || text !== prevProps.text) {
            console.log('GiftedChat - componentDidUpdate triggered');
            this.setMessages(messages || []);
            this.setTextFromProp(text);
        }
    }
    ...
    renderMessages = () => {
        ...
        return (
            <div
                className={'giftedChatMessagesWindowContainer'}
                style={{
